...
/** Implementación de [RecipeUrlImportClient] contra la API de Mensajes de Anthropic (Claude). */
object AnthropicRecipeUrlImportClient : RecipeUrlImportClient {
            ...
            try {
                val requestBody = json.encodeToString(
                    ...
                    AnthropicRequest(
                        ...
                        messages = listOf(AnthropicMessage(content = listOf(AnthropicContentBlock(type = "text", text = buildUrlImportPrompt(url, pageText)))))
                    )
                )
