...
/** Implementación de [DishRecipeGenerationClient] contra la API REST de Google Gemini. */
object GeminiDishRecipeGenerationClient : DishRecipeGenerationClient {
        ...
        withContext(Dispatchers.IO) {
            try {
                val requestBody = json.encodeToString(
                    ...
                    GeminiRequest(
                        contents = listOf(GeminiContent(parts = listOf(GeminiPart(text = buildDishRecipePrompt(dish))))),
